...
#### Language Support (7 new languages, 29+ total)
...
#### Indexing Speed (10-100x improvements)
- Native git bindings for gitignore exclusions replacing Python-based pattern matching
