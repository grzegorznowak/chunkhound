...
def test_safe_recovery_is_multiset_deterministic_under_collisions() -> None:
    removed1 = GapChangeItem(
        ...
        confidence=1.0,
        primary_key_kind="stable_key",
        primary_key_hash="0000000000000001",
        key_strength=1,
        had_collision=False,
        collision_group_size=1,
        old=_sym_handle(path="a.py", symbol="foo", text_hash="t1", stable_key_hash="a"),
    ...
    removed2 = GapChangeItem(
        ...
        confidence=1.0,
        primary_key_kind="stable_key",
        primary_key_hash="0000000000000002",
        key_strength=1,
        had_collision=False,
        collision_group_size=1,
        old=_sym_handle(
    ...
    added1 = GapChangeItem(
        ...
        confidence=1.0,
        primary_key_kind="stable_key",
        primary_key_hash="0000000000000003",
        key_strength=1,
        had_collision=False,
        collision_group_size=1,
        old=None,
    ...
    added2 = GapChangeItem(
        ...
        confidence=1.0,
        primary_key_kind="stable_key",
        primary_key_hash="0000000000000004",
        key_strength=1,
        had_collision=False,
        collision_group_size=1,
        old=None,
...
def test_safe_recovery_skips_oversized_bucket_and_emits_warning() -> None:
    ...
    added = [
        GapChangeItem(
            ...
            confidence=1.0,
            primary_key_kind="stable_key",
            primary_key_hash=f"{(1000 + i):016x}",
            key_strength=1,
            had_collision=False,
            collision_group_size=1,
            old=None,
...
def test_safe_recovery_placeholder_numeric_drift_does_not_count_as_rename() -> None:
    removed = GapChangeItem(
        ...
        confidence=1.0,
        primary_key_kind="stable_key",
        primary_key_hash="00000000000000aa",
        key_strength=1,
        had_collision=False,
        collision_group_size=1,
        old=_sym_handle(
    ...
    added = GapChangeItem(
        ...
        confidence=1.0,
        primary_key_kind="stable_key",
        primary_key_hash="00000000000000bb",
        key_strength=1,
        had_collision=False,
        collision_group_size=1,
        old=None,
